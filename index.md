...
```{r, echo=FALSE, out.height = '123px', out.width = '533px'}
knitr::include_graphics("R_ignore/images/simplegenlogo.png")
```
...
knitr::include_graphics("R_ignore/images/pipeline.png")
```
