...
If you have any problems installing, please check the [Known issues](https://mrc-ide.github.io/SIMPLEGEN/articles/known_issues.html) page to see if there is a known solution. If not then please [raise an issue](https://github.com/mrc-ide/SIMPLEGEN/issues) on github.
