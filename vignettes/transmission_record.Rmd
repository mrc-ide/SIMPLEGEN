...
We can also try to think of examples that violate this assumption. We can imagine a model in which a particular allele confers resistance to a commonly used antimalarial drug, thereby increasing the chance that infection persists even after treatment. Here the presence or absence of the allele directly impacts the progression of the disease, and so we would need to know genotypes at the time of simulating transmission. This violates the assumption above.
